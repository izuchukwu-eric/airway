    ...
    <div class="content">
      <div class="wallet">
          <div class="container">
              <div class="row">
                  <div class="col-lg-12">
                      <h3>Edit Package Order</h3>
                  </div>
                  <?php echo"$success";?>
                 <?php echo "$fail";?>
                  <?php
                     $get_track = "SELECT * FROM delivery";
                     $run_track = mysqli_query($connect,$get_track);
                     while($row_track = mysqli_fetch_array($run_track)){
                         $id = $row_track['id'];
                        ...
                        <div class='card'>
                              <div class='card-body'>
                                  ...
                                  <input type='text' class='form-control' id='inputEmail4' value='$tracking_id' name='tracking_id'>
                                  </div>
                                  <div class='form-group col-md-12'>
                                  <label for='inputEmail4'>Order Id</label>
                                  <input type='text' class='form-control' id='inputEmail4' value='$order_id' name='order_id'>
                                  </div>
                                      <div class='form-group col-md-12'>
                                      <label for='inputEmail4'>Order Date</label>
                                      <input type='date' class='form-control' id='inputEmail4' value='$order_date' name='order_date'>
                            
                                      </div>
                                      <div class='form-group col-md-12'>
                                      <label for='inputPassword4'>Delivery Date</label>
                                      <input type='date' class='form-control' id='inputPassword4'  value='$delivery_date'name='delivery_date' >
                               
                                      </div>
                                      
                                      <div class='form-group col-md-12'>
                                      <label for='inputEmail4'>Sent From</label>
                                      <input type='text' class='form-control' id='inputPassword4' value='$sent_from' name='sent_from'>
                                      </div>
                                      <div class='form-group col-md-12'>
                                      <label for='inputEmail4'>Sent To</label>
                                      <input type='text' class='form-control' id='inputPassword4' value='$sent_to' name='sent_to'>
                                      </div>
                                      <div class='form-group col-md-12'>
                                      <label for='inputPassword4'>Email</label>
                                      <input type='email' class='form-control' id='inputPassword4' value='$email' name='email'>
                                      </div>
                                      <div class='form-group col-md-12'>
                                      <label for='inputPassword4'>Destination</label>
                                      <input type='text' class='form-control' id='inputPassword4' value='$destination' name='destination'>
                                      </div>
      ...
      <input type='text' class='form-control' id='inputPassword4' value='$product_name'  name='product_name'>
      </div>
      <div class='form-group col-md-3'>
      <label for='inputPassword4'>Product Image</label>
     <img src='$product_image' style='width:100%;'>
      </div>
      
      <div class='form-group col-md-3'>
      <label for='inputPassword4'>Product Price</label>
      <input type='number' class='form-control' id='inputPassword4' value='$product_price' name='product_price'  step='.01' >
      </div>
      <div class='form-group col-md-3'>
      <label for='inputPassword4'>Quantity</label>
      <input type='number' class='form-control' id='inputPassword4' value='$quantity' name='quantity' >
      </div>
    
      
      <input type='hidden' class='form-control' id='inputPassword4' name='id' value='$id'>
      <div class='form-group col-md-12'>
      <label for='inputPassword4'>Copy and Paste New Product Image</label>
      <input type='text' class='form-control' id='inputPassword4' value='$product_image' name='product_image'>
      </div>
      <div class='form-group col-md-12'>
