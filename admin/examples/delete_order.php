<?php
 ...
 include("../include/delete_order.php");
 $yes = "";
...
<div class="wrapper">
    ...
    <div class="content">
                     ...
                     while($row_track = mysqli_fetch_array($run_track)){
                        ...
                        <div class='card'>
                              <div class='card-body'>
                                  ...
                                  <input type='text' class='form-control' id='inputEmail4' placeholder='$tracking_id' readonly>
                                  </div>
                                  <div class='form-group col-md-12'>
                                  <label for='inputEmail4'>Order Id</label>
                                  <input type='text' class='form-control' id='inputEmail4' placeholder='$order_id' readonly>
                                  </div>
                                      <div class='form-group col-md-12'>
                                      <label for='inputEmail4'>Order Date</label>
                                      <input type='text' class='form-control' id='inputEmail4' placeholder='$order_date' disabled>
                                      </div>
                                      <div class='form-group col-md-12'>
                                      <label for='inputPassword4'>Delivery Date</label>
                                      <input type='date' class='form-control' id='inputPassword4'  placeholder='$delivery_date' disabled >
                                      </div>
                                      
                                      <div class='form-group col-md-12'>
                                      <label for='inputEmail4'>Sent From</label>
                                      <input type='text' class='form-control' id='inputPassword4' placeholder='$sent_from' disabled>
                                      </div>
                                      <div class='form-group col-md-12'>
                                      <label for='inputEmail4'>Sent To</label>
                                      <input type='text' class='form-control' id='inputPassword4' placeholder='$sent_to' disabled>
                                      </div>
                                      <div class='form-group col-md-12'>
                                      ...
                                      <input type='text' class='form-control' id='inputPassword4' placeholder='$destination' disabled>
                                      </div>
      ...
      <input type='text' class='form-control' id='inputPassword4' placeholder='$product_name'  disabled>
      </div>
      <div class='form-group col-md-3'>
     ...
     <img src='$product_image' style='width:100%;'>
      ...
      <input type='number' class='form-control' id='inputPassword4' placeholder='$product_price'  step='.01' disabled>
      </div>
      <div class='form-group col-md-3'>
      <label for='inputPassword4'>Quantity</label>
      <input type='number' class='form-control' id='inputPassword4' placeholder='$quantity' disabled>
      </div>
      ...
      <input type='text' class='form-control' id='inputPassword4' placeholder='$status' disabled>
      </div>
