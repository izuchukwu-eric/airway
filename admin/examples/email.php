    ...
    <div class="main-panel">
     ...
     <div id="readroot" style="display:none;">
      <div class="form-row" >
                                ...
                                <input type="text" class="form-control" id="inputPassword4" placeholder="Copy and paste barcode image address" name="barcode[]" required>
                                </div>
                                <div class="form-group col-md-2">
                                <label for="inputPassword4">Product Price</label>
                                <input type="text" class="form-control" id="inputPassword4" placeholder="Product Price" name="product_price[]" required>
                                </div>
                                ...
                                <input type="number" class="form-control" id="inputPassword4" placeholder="Quantity" name="quantity[]" required>
                                    ...
                                    <input type="button" class='btn btn-danger' value="Remove Product" onclick="this.parentNode.parentNode.removeChild(this.parentNode);" />
                  ...
                  <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <input type="text" class="form-control" id="inputEmail4" placeholder="Enter First Name" name ="first_name" required>
                                </div>
                                <div class="form-group col-md-12">
                       ...
                       <option value="Afghanistan">Afghanistan</option>
                            ...
                            <option value="Zimbabwe">Zimbabwe</option>
                                ...
                                <input type="number" class="form-control" id="inputPassword4" placeholder="Enter Discount" name="discount" required>
                                </div>
                           ...
                           <div class="form-row">
                               ...
                               <div class="col-md-4">
                               <input type="button" class="btn btn-success" onclick="moreFields()" value="Add Products" />
                               </div>
                               <div class="col-md-4">
