...
<div class="wrapper">
  ...
  <table class="table" style = "width:100%;" id="refer">
    ...
    <tbody>
      <?php
       $get_live = "select * from live_feed_admin order by id DESC";
       ...
       $ip_address = $row_live['ip'];
       $description_live =$row_live['description'];
       $arr = array('info','primary','danger','secondary','success','warning','light','dark');
       $random = rand(0,7);

         echo" <tr>
         <td class='text-center'>$id</td>
         <td><a href='#' class='btn btn-primary'>$date_live</a> </br> </td>
         <td><a href='#' class='btn btn-$arr[$random]'>$type_live</a></td>
         <td><a href='#' class='btn btn-secondary'>$description_live</a> </br></td>
         <td><a href='#' class='btn btn-$arr[$random]'>$ip_address</a></td>
